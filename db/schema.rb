...
ActiveRecord::Schema.define(version: 20170725140043) do
  ...
  create_table "expense_group_free_options", force: :cascade do |t|
    ...
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["expense_group_id", "registrant_type"], name: "free_options_group_reg_type", unique: true, using: :btree
    t.index ["expense_group_id"], name: "index_expense_group_free_options_on_expense_group_id", using: :btree
  end
  ...
  create_table "registrant_group_members", force: :cascade do |t|
    ...
    t.index ["registrant_group_id"], name: "index_registrant_group_members_on_registrant_group_id", using: :btree
    t.index ["registrant_id", "registrant_group_id"], name: "reg_group_reg_group", unique: true, using: :btree
    t.index ["registrant_id"], name: "index_registrant_group_members_on_registrant_id", using: :btree
  end

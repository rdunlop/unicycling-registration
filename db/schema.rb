...
ActiveRecord::Schema.define(version: 20150312120027) do
  ...
  add_index "event_categories", ["event_id", "position"], name: "index_event_categories_on_event_id_and_position", unique: true, using: :btree
  ...
  create_table "tenant_aliases", force: true do |t|
  ...
  create_table "volunteer_choices", force: true do |t|
    t.integer  "registrant_id"

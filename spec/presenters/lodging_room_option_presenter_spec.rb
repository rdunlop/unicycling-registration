...
describe LodgingRoomOptionPresenter do
  ...
  describe "#days_available" do
    ...
    context "with a broken range of lodging days" do
      let!(:lodging_day1) { FactoryBot.create(:lodging_day, lodging_room_option: lodging_room_option, date_offered: Date.new(2017, 1, 1)) }
      let!(:lodging_day2) { FactoryBot.create(:lodging_day, lodging_room_option: lodging_room_option, date_offered: Date.new(2017, 1, 2)) }
      let!(:lodging_day3) { FactoryBot.create(:lodging_day, lodging_room_option: lodging_room_option, date_offered: Date.new(2017, 1, 5)) }
      let!(:lodging_day4) { FactoryBot.create(:lodging_day, lodging_room_option: lodging_room_option, date_offered: Date.new(2017, 1, 6)) }

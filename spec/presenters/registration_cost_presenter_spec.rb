...
describe RegistrationCostPresenter do
  ...
  describe "#describe_entries" do
    ...
    context "given a block" do
      let!(:rce2) { FactoryBot.create(:registration_cost_entry, min_age: 10, max_age: 20, registration_cost: registration_cost) }
      let!(:rce3) { FactoryBot.create(:registration_cost_entry, min_age: 21, max_age: 99, registration_cost: registration_cost) }

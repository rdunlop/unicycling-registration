...
describe BibNumberFinder::RegistrantMatch do
  ...
  let(:new_registrant) { FactoryGirl.build(:competitor, first_name: "Bob", last_name: "Smith", birthday: birthday) }
  ...
  context "with a matching registrant in another tenant" do
    ...
    before do
      ...
      Apartment::Tenant.switch "other" do
        FactoryGirl.create(:competitor, user: user, first_name: "Bob", last_name: "Smith", birthday: birthday, bib_number: 123)
      end
    end

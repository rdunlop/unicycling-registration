...
describe ConventionSetup::LodgingRoomOptionsController do
  ...
  # describe "GET new" do
  #   it "renders" do
  #     lodging = FactoryBot.create(:lodging_room_type)
  ...
  describe "GET edit" do
    it "shows the form" do
      lodging_room_option = FactoryBot.create(:lodging_room_option)
  ...
  #     let(:valid_attributes) { FactoryBot.attributes_for(:lodging_room_option) }
  ...
  describe "PUT update" do
    let!(:lodging_room_option) { FactoryBot.create(:lodging_room_option) }
    let(:new_valid_attributes) { FactoryBot.attributes_for(:lodging_room_option) }

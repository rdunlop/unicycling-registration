...
describe JudgesController do
  before do
    ...
    @judge_type = FactoryBot.create(:judge_type, event_class: @ec.event_class)
    @other_judge_type = FactoryBot.create(:judge_type, event_class: "Flatland")
  end
  ...
  describe "POST copy_judges" do
    it "copies judges from event to event" do
      ...
      FactoryBot.create(:judge, competition: @new_competition)
    ...
    it "fails to copy judges from a different type of competition" do
      competition = FactoryBot.create(:distance_competition)
      judge_type = FactoryBot.create(:judge_type, event_class: "High/Long")
      judge = FactoryBot.create(:judge, judge_type: judge_type, competition: competition)
  ...
  describe "DELETE destroy" do
    it "destroys the requested judge" do
      judge = FactoryBot.create(:judge, competition: @ec)
      expect do

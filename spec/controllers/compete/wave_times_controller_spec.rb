...
describe Compete::WaveTimesController do
  ...
  describe "POST create" do
    ...
    it "creates a new wave time" do
      expect do
        post :create, competition_id: competition.id, wave_time: attributes
  ...
  describe "GET edit" do
    it "renders" do
      get :edit, id: wave_time.id, competition_id: competition.id
      expect(response).to be_success
    end
  end
  ...
  describe "PUT update" do
    it "updates wave time" do
      put :update, competition_id: competition.id, id: wave_time.id, wave_time: { minutes: "10" }
  ...
  describe "DELETE destroy" do
    it "removes" do
      wave_time
      expect do
        delete :destroy, competition_id: competition.id, id: wave_time.id
      end.to change(WaveTime, :count).by(-1)
    end
  end
end

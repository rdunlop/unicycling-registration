...
RSpec.describe JumpLimit::TripleFaultOrMaxAttempts12 do
  ...
  context "when there are 12 attempts, but not triple fault" do
    let(:distance_attempts) do
      [
        FactoryGirl.create(:distance_attempt, fault: true, distance: 1),
        FactoryGirl.create(:distance_attempt, fault: true, distance: 2),
        FactoryGirl.create(:distance_attempt, fault: true, distance: 3),
        FactoryGirl.create(:distance_attempt, fault: true, distance: 4),
        FactoryGirl.create(:distance_attempt, fault: true, distance: 5),
        FactoryGirl.create(:distance_attempt, fault: true, distance: 6),
        FactoryGirl.create(:distance_attempt, fault: true, distance: 7),
        FactoryGirl.create(:distance_attempt, fault: true, distance: 8),
        FactoryGirl.create(:distance_attempt, fault: true, distance: 9),
        FactoryGirl.create(:distance_attempt, fault: true, distance: 10),
        FactoryGirl.create(:distance_attempt, fault: true, distance: 11),
        FactoryGirl.create(:distance_attempt, fault: true, distance: 12)
      ]
    end

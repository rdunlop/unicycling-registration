...
RSpec.describe DistanceError::GreaterThanOrEqual do
    ...
    context "when the previous distance was a fault" do
      ...
      context "when the current distance is less than the previous" do
        ...
        it "returns an error message" do
          expect(message).to eq("New Distance (4cm) must be greater than or equal to 5cm")
        end
      end
  ...
  describe "#single_fault_message" do
    it "allows greater than or equal value" do

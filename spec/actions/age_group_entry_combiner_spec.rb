...
RSpec.describe AgeGroupEntryCombiner do
  ...
  let!(:age_group_entry) { FactoryBot.create(:age_group_entry, age_group_type: age_group_type, start_age: 0, end_age: 10) }
  let!(:age_group_entry_2) { FactoryBot.create(:age_group_entry, age_group_type: age_group_type, start_age: 11, end_age: 20) }

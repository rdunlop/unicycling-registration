...
describe RegistrantGroupManager do
  ...
  describe "#add_member" do
    ...
    context "with a limit of 2 members" do
      let(:registrant_group_type) { FactoryBot.create(:registrant_group_type, max_members_per_group: 2) }
      ...
      it "cannot exceed the group size limit" do
        FactoryBot.create(:registrant_group_member, registrant_group: registrant_group)
  ...
  describe "remove_leader" do
    ...
    context "with 2 leaders" do
      let!(:other_leader) { FactoryBot.create(:registrant_group_leader, registrant_group: registrant_group) }

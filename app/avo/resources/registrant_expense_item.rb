class Avo::Resources::RegistrantExpenseItem < Avo::BaseResource
  self.model_class = ::RegistrantExpenseItem
  self.title = :id
  self.includes = []
  self.search = {
  ...
  def fields
    ...
    field :custom_cost_cents, as: :number
    field :free, as: :boolean
    field :locked, as: :boolean
    field :system_managed, as: :boolean

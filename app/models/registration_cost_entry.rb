...
class RegistrationCostEntry < ApplicationRecord
  ...
  belongs_to :registration_cost, inverse_of: :registration_cost_entries, touch: true
  validates :min_age, :max_age, absence: true, if: proc { |el| el.registration_cost.registrant_type == "spectator" }

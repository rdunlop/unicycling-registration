class ConventionSetup::CouponCodesController < ConventionSetup::BaseConventionSetupController
  ...
  def coupon_code_params
    params.require(:coupon_code).permit(:name, :description, :inform_emails, :maximum_registrant_age, :code, :max_num_uses, :price, expense_item_ids: [], lodging_room_option_ids: [])
  end
end

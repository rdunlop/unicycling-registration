...
class AdditionalRegistrantAccessesController < ApplicationController
  ...
  def accept_readonly
    ...
    respond_to do |format|
      if @additional_registrant_access.update(declined: false, accepted_readonly: true)
  ...
  def decline
    ...
    respond_to do |format|
      if @additional_registrant_access.update(declined: true, accepted_readonly: false)

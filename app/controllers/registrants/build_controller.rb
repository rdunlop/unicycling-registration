class Registrants::BuildController < ApplicationController
  ...
  def update
    ...
    @registrant.update(registrant_params) unless (wizard_value(step) == :lodging) || (wizard_value(step) == :expenses)
  ...
  def attributes
    [:first_name, :pronouns, :other_pronoun, :gender, :last_name, :middle_initial, :birthday, :registrant_type, :volunteer,

Rails.application.routes.draw do
  ...
  scope "(:locale)", locale: /en|fr|de|hu|es|ja|ko|it|da|nl/ do
    ...
    namespace :export do
      ...
      get :download_payment_details_by_category
    ...
    scope module: "competition_setup" do
      ...
      resources :imported_registrants, only: %i[index create destroy]
    end
    ...
    scope module: "admin" do
      ...
      resources :medical_certificates, only: %i[index update] do
      end
    end

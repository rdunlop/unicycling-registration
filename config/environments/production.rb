Rails.application.configure do
  ...
  config.public_file_server.enabled = false # nginx should serve static assets
  ...
  # config.active_job.queue_adapter     = :resque # config.active_job.queue_name_prefix = "workspace_#{Rails.env}"

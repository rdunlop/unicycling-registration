...
Apartment.configure do |config|
  ...
  #
  config.excluded_models = %w[Tenant TenantAlias Tolk::Locale Tolk::Translation Tolk::Phrase User UserConvention ConventionSeries ConventionSeriesMember SystemLabelType]

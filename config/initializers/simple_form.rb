...
SimpleForm.setup do |config|
  ...
  config.wrappers :default, class: :field,
    ...
    ## Inputs
    b.use :label_input
    b.use :hint,  wrap_with: { tag: :div, class: :input_details }
...
=end
    module BooleanWrap
      ...
      def label_html_options
        ...
        options[:class] ||= []
        options[:class] << "label--boolean"
        options[:class] << "label--#{input_type}"
        options[:class] << "js--inputBoolean"
...
=end
    module RadioCollectionWrap
      ...
      def input_options
        ...
        options[:item_wrapper_tag] = false
        options[:item_label_class] = "label--boolean label--radio js--inputBoolean"
